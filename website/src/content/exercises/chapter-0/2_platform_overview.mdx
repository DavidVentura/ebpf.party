...
The editor compiles your code locally as you type, but you can disable this by clicking the <ControlButton style={{display: "inline"}}><Braces size={18} /></ControlButton> button. Compilation errors are highlighted inline.
